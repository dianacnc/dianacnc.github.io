...
<div class="col-lg-4 col-md-4 col-sm-4">
    <div class="work-img">
     ...
     <p><strong>Промышленный компьютер</strong>
     </p>
    </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4">
    <div class="work-img">
     <img src="/static/img/works/cnc-03-2018/Monitor.png">
     <strong>Интерфейс оператор-СЧПУ</strong>
    </div>
</div>
<div class="col-lg-4 col-md-4 col-sm-4">
    <div class="work-img">
     <img src="/static/img/works/cnc-03-2018/Timer.png">
     <strong>Плата системного времени</strong>
     <br>
    </div>
</div>
